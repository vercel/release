 ...
 */
exports.tap = function (labelOrCb = 'release:promise') {
  const cb = typeof labelOrCb === 'function' ? labelOrCb : debug(labelOrCb)
 ...
 */
exports.tap.error = function (labelOrCb = 'release:promise') {
  const cb = typeof labelOrCb === 'function' ? labelOrCb : debug(labelOrCb)
